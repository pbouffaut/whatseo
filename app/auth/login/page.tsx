    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-3xl text-warm-white mt-6 mb-2">Welcome back</h1>
        ...
        <p className="text-center text-warm-gray text-sm mt-8">
          ...
          <Link href={`/auth/signup?redirect=${redirect}`} className="text-gold hover:text-gold-light">
            Sign up
          </Link>
        </p>
      </div>
