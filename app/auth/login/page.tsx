    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20 bg-background">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-3xl text-on-surface mt-6 mb-2 tracking-tight">Welcome back</h1>
          <p className="text-on-surface-muted text-sm">Sign in to your account</p>
        </div>
        ...
        <p className="text-center text-on-surface-muted text-sm mt-8">
          ...
          <Link href={`/auth/signup?redirect=${redirect}`} className="text-primary hover:text-primary-container">
            Sign up
          </Link>
        </p>
      </div>
