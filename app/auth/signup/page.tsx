    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="font-serif text-3xl text-warm-white mb-3">Check your email</h1>
          <p className="text-warm-gray">We sent a confirmation link to <span className="text-warm-white">{email}</span>. Click the link to activate your account.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <Link href="/" className="text-2xl font-bold text-warm-white">
            What<span className="text-gold">SEO</span><span className="text-warm-gray text-sm">.ai</span>
          </Link>
          <h1 className="font-serif text-3xl text-warm-white mt-6 mb-2">Create your account</h1>
          <p className="text-warm-gray text-sm">Start optimizing your SEO today</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 bg-gold text-dark rounded-full font-semibold hover:bg-gold-light transition-colors disabled:opacity-60"
          >
        ...
        <p className="text-center text-warm-gray text-sm mt-8">
          ...
          <Link href={`/auth/login?redirect=${redirect}`} className="text-gold hover:text-gold-light">
            Sign in
          </Link>
        </p>
      </div>
...
export default function SignupPage() {
  return <Suspense fallback={<div className="min-h-screen" />}><SignupForm /></Suspense>;
}
